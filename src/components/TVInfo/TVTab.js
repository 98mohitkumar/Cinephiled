    ...
    <Fragment>
      <Tabs tabList={tabList} currentTab={activeTab} styling={{ tabStyling }}>
        {tabList.map(({ key, name, svg }) => (
          <TabSelectionTitle key={key} onClick={() => setTab(key)} $active={activeTab === key} $tv={true}>
      ...
      <AnimatePresence mode='wait' initial={false}>
        {activeTab === "cast" && (
          <motion.div key='cast' {...opacityMotionTransition}>
            <ModulesWrapper>
        ...
        {activeTab === "backdrops" && (
          <motion.div key='backdrops' {...opacityMotionTransition}>
            <ModulesWrapper>
        ...
        {activeTab === "posters" && (
          <motion.div key='posters' {...opacityMotionTransition}>
            <ModulesWrapper>
